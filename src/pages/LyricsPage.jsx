        ...
        <div className="col-span-1 space-y-4">
            ...
            <div className="space-y-2">
              {LANGUAGES.map(l => (
                <button
                  ...
                  className={`w-full p-2.5 rounded-lg text-left transition-all flex items-center gap-2 ${language === l.id
                    ? 'bg-gradient-to-r from-violet-500/20 to-pink-500/20 border border-violet-500/30'
                    : 'bg-white/5 border border-white/5 hover:border-white/10'
                    }`}
                >
            ...
            <div className="flex gap-2">
              {VARIATIONS.map(v => (
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-sm font-semibold transition-all ${variation === v
                    ? 'bg-gradient-to-r from-violet-500 to-pink-500 text-white'
                    : 'bg-white/5 text-gray-400 hover:bg-white/10'
                    }`}
                >
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-violet-500/50 placeholder-gray-600"
                />
              </div>
            </div>
          </div>
          ...
          <div className="gradient-border p-5">
            ...
            <textarea
              ...
              rows={5}
              className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-violet-500/50 placeholder-gray-600 resize-none"
            />
          ...
          {result && (
            <div className="space-y-4">
              ...
              {result.result?.fullText && (
                <div className="p-4 rounded-lg bg-white/5 border border-white/5 max-h-[60vh] overflow-y-auto">
                  <div className="flex items-center justify-between mb-2">
